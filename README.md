...
- [basement >= 0.0.4 && <= 0.0.5](https://hackage.haskell.org/package/basement)
...
- [cmdargs >= 0.10.18 && <= 0.10.19](https://hackage.haskell.org/package/cmdargs-0.10.19)
...
- [memory >= 0.14.10 && <= 0.14.12](https://hackage.haskell.org/package/memory)
...
- [SHA-1.6.4.2](https://hackage.haskell.org/package/SHA-1.6.4.2)
