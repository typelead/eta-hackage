...
- [aeson >= 0.11.3.0 && <= 1.2.3.0](https://hackage.haskell.org/package/aeson)
...
- [network-uri >= 2.6.0.3 && <= 2.6.1.0](https://hackage.haskell.org/package/network-uri)
...
- [shake >= 0.16.2 && <= 0.16.3](https://hackage.haskell.org/package/shake)
